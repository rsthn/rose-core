...
test(  5, 'HELLO wOrlD' === Text::upperCaseFirst($text) );
//test(  6, 'HELLO WOrlD' === Text::upperCaseWords($text) );
test(  7, 7 === Text::position($text, 'Or') );
test(  8, 7 === Text::position($text, 'Or', 4) );
test(  9, false === Text::position($text, 'X') );
test( 10, 7 === Text::indexOf($text, 'Or') );
test( 11, false === Text::indexOf($text, 'X') );
test( 12, 7 === Text::revIndexOf($text, 'Or') );
test( 13, 7 === Text::revIndexOf($text, 'Or', 5) );
test( 14, false === Text::revIndexOf($text, 'Or', -5) );
...
test( 23, 'HE...' === Text::truncate($text, 5) );
...
test( 30, '' === Text::upperCaseFirst($text) );
//test( 31, '' === Text::upperCaseWords($text) );
test( 32, false === Text::position($text, 'Or') );
test( 33, false === Text::position($text, 'Or', 4) );
test( 34, false === Text::position($text, 'X') );
test( 35, false === Text::indexOf($text, 'Or') );
test( 36, false === Text::indexOf($text, 'X') );
test( 37, false === Text::revIndexOf($text, 'Or') );
test( 38, false === Text::revIndexOf($text, 'Or', 5) );
test( 39, false === Text::revIndexOf($text, 'Or', -5) );
...
test( 55, '0' === Text::upperCaseFirst($text) );
//test( 56, '0' === Text::upperCaseWords($text) );
test( 57, 0 === Text::position($text, '0') );
test( 58, false === Text::position($text, '0', 4) );
test( 59, false === Text::position($text, 'X') );
test( 60, 0 === Text::indexOf($text, '0') );
test( 61, false === Text::indexOf($text, 'X') );
test( 62, 0 === Text::revIndexOf($text, '0') );
test( 63, false === Text::revIndexOf($text, 'Or', 5) );
test( 64, false === Text::revIndexOf($text, 'Or', -5) );
