...
test(  3, '1970-01-01 00:00:00' === (string)$c );
...
test(  9, 10 === $b->minute );
test( 10, 32 === $b->second );
test( 11, 0 === (int)$a->getTimestamp() );
test( 12, 0 === (int)$c->getTimestamp() );
test( 13, 0 === (int)DateTime::getUnixTimestamp('1970-01-01 00:00:00') );
...
test( 16, 0 === $a->sub('1970-01-09 04:15:00', DateTime::MINUTE) );
...
test(  6, '08:45 AM' === $L->format('TIME', $a, '%H:%M %p') );
test(  7, '01/09/70' === $L->format('DATE', $a, '%m/%d/%y') );
test(  8, '01/09/1970' === $L->format('DATE', $a, '%m/%d/%Y') );
test(  9, '01/09/1970 08:45 AM' === $L->format('DATETIME', $a, '%m/%d/%Y %H:%M %p') );
test( 10, 'Fri, 09 Jan 1970 04:15:00 GMT' === $L->format('GMT', $a) );
test( 11, '1970-01-09T04:15:00Z' === $L->format('UTC', $a) );
test( 12, '1970-01-09' === $L->format('ISO_DATE', $a) );
test( 13, '08:45:00' === $L->format('ISO_TIME', $a) );
test( 14, '1970-01-09 08:45:00' === $L->format('ISO_DATETIME', $a) );
